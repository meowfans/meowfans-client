          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="flex items-center gap-8 md:gap-12 py-4 border-y border-border/50">
              <div className="flex flex-col gap-1">
                <span className="text-2xl font-bold text-foreground">{creator.totalPost}</span>
                <span className="text-muted-foreground text-xs font-medium uppercase tracking-widest">Posts</span>
              </div>
              <div className="flex flex-col gap-1">
                <span className="text-2xl font-bold text-foreground">{creator.followersCount}</span>
                <span className="text-muted-foreground text-xs font-medium uppercase tracking-widest">Followers</span>
              </div>
              <div className="flex flex-col gap-1">
                <span className="text-2xl font-bold text-foreground">{creator.vaultCount}</span>
                  ...
                  <span className="flex items-center gap-2 group">
                    <Grid
                      className={`h-4 w-4 transition-colors
                         ${activeTab === 'posts' ? 'text-indigo-400' : 'text-zinc-500 group-hover:text-zinc-300'}`}
                    />
                    <span
