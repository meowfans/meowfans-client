    ...
    <div className="flex flex-wrap items-start gap-6 mb-10">
      ...
      <div className="flex-1 min-w-[250px]">
        ...
        {vault.isPurchased ? (
          ...
          vault.unlockPrice && (
            <div className="mt-4 flex flex-col gap-2 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-zinc-800 dark:to-zinc-900 p-4 rounded-xl border border-pink-200 dark:border-zinc-700 shadow-sm">
