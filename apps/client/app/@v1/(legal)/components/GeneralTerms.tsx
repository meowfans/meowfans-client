      ...
      <article className="prose prose-slate dark:prose-invert max-w-5xl mx-auto">
        ...
        <section>
          ...
          <p>
            ...
            immediately at <a href="mailto:support@meowfans.app">support@meowfans.app</a>.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Users must promptly notify MeowFans at <a href="mailto:privacy@meowfans.app">privacy@meowfans.app</a> if they suspect a security
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:support@meowfans.app"> support@meowfans.app</a> with a detailed description and supporting documentation. We
        ...
        <section>
          ...
          <p>
            ...
            MeowFans should be sent to <a href="mailto:support@meowfans.app">support@meowfans.app</a> and will be deemed received upon
        ...
        <footer>
          <p className="text-sm text-gray-500 mt-8">
            Contact: <a href="mailto:support@meowfans.app">support@meowfans.app</a> • Last updated: {moment().format('L')}
          </p>
        </footer>
      </article>
    </main>
