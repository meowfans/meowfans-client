      ...
      <article className="prose prose-slate dark:prose-invert max-w-5xl mx-auto">
        ...
        <section id="rights">
          ...
          <p>
            ...
            <a href="mailto:privacy@meowfans.app"> privacy@meowfans.app</a>. We may require identity verification before fulfilling
            requests.
          </p>
        </section>
        ...
        <section id="ccpa">
          ...
          <p>
            ...
            requests via <a href="mailto:privacy@meowfans.app">privacy@meowfans.app</a>.
          </p>
        </section>
        ...
        <section id="gdpr-dpia">
          ...
          <p>
            ...
            <a href="mailto:privacy@meowfans.app">privacy@meowfans.app</a> for inquiries.
          </p>
        </section>
        ...
        <section id="contact-privacy">
          ...
          <p>
            Privacy contact: <a href="mailto:privacy@meowfans.app">privacy@meowfans.app</a>. For escalations, include account details and
        ...
        <footer>
          <p className="text-sm text-gray-500 mt-8">
            Contact: <a href="mailto:privacy@meowfans.app">privacy@meowfans.app</a> • Last updated: {moment().format('L')}
          </p>
        </footer>
      </article>
    </main>
