      ...
      <article className="prose prose-slate dark:prose-invert max-w-5xl mx-auto">
        ...
        <section id="fan-account">
          ...
          <p>
            ...
            <a href="mailto:support@meowfans.app">support@meowfans.app</a>.
          </p>
        </section>
        ...
        <section id="support">
          ...
          <p>
            For billing or conduct disputes, contact support at <a href="mailto:support@meowfans.app">support@meowfans.app</a>. We may
