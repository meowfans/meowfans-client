    ...
    <div className="flex flex-1 flex-col bg-background">
      <div className="relative overflow-hidden bg-secondary/10 py-16 md:py-24 border-b border-white/5">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tight uppercase italic bg-linear-to-r from-foreground to-foreground/50 bg-clip-text text-transparent mb-6">
            Explore Tutorials
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-12 md:py-16">
        ...
        {filteredTutorials.length === 0 && (
          <div className="text-center py-24">
            ...
            <h2 className="text-2xl font-black uppercase italic">No tutorials found</h2>
