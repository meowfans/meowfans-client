...
export default function NotFound() {
  return (
    <div className="relative flex min-h-[calc(100vh-4rem)] flex-1 flex-col items-center justify-center overflow-hidden bg-background text-foreground">
      ...
      <div className="absolute bottom-8 text-xs text-muted-foreground">
        &copy;2026-{new Date().getFullYear()} MeowFans. All rights reserved.
      </div>
    </div>
  );
}
