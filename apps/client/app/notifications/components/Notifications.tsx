...
export function Notifications() {
  ...
  return (
    <div className="flex flex-1 flex-col gap-3 p-2 bg-background/50 backdrop-blur-3xl h-screen">
      ...
      <div className="flex items-center gap-2 overflow-x-auto p-2 scrollbar-none">
        {['all', 'unread', 'mentions'].map((f) => (
          <button
            ...
            className={cn(
              ...
              filter === f
                ? 'bg-primary text-white shadow-xl shadow-primary/25 scale-100'
      ...
      <Card className="border-none bg-secondary/5 ring-1 ring-white/5 overflow-hidden rounded-4xl">
        <ScrollArea className="h-150 md:h-[calc(100vh-300px)]">
