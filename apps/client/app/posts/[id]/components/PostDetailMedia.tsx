  ...
  return (
    <div className="relative aspect-4/5 md:aspect-video w-full overflow-hidden bg-black/40">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center p-6 md:p-8 bg-black/60 backdrop-blur-xl">
        <div className="mb-4 md:mb-6 rounded-3xl md:rounded-[2.5rem] bg-white/5 p-6 md:p-8 border border-white/10 shadow-2xl rotate-3">
          <Lock className="h-10 w-10 md:h-16 md:w-16 text-primary" />
        </div>
        <h3 className="text-xl md:text-3xl font-black italic uppercase tracking-tighter text-white mb-2 text-center">Content Locked</h3>
        ...
        <InteractionButton
          ...
          className="h-12 md:h-16 px-6 md:px-10 rounded-2xl md:rounded-4xl bg-primary text-primary-foreground font-black uppercase italic tracking-widest shadow-[0_15px_30px_-5px_rgba(var(--primary),0.4)] hover:scale-105 transition-all text-xs md:text-base w-full md:w-auto"
        >
