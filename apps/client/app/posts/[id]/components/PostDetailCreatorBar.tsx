...
export const PostDetailCreatorBar = ({ creatorUsername, creatorAvatarUrl, createdAt, creatorId }: PostDetailCreatorBarProps) => {
  return (
    <div className="flex items-center p-4 md:p-6 md:px-8 border-b border-white/5 bg-white/[0.02]">
      <Link href={`/creators/${creatorId}`} className="group flex items-center gap-3 md:gap-4">
