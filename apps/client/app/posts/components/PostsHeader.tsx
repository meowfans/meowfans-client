...
export const PostsHeader = ({ searchTerm, onSearchChange, postTypes, onPostTypesChange, viewMode, onViewModeChange }: PostsHeaderProps) => {
  ...
  return (
    <div className="flex-none p-2 bg-linear-to-b from-secondary/10 to-transparent border-b border-white/5">
      <div className="flex flex-col gap-2 min-w-0">
        <div className="flex items-center justify-between gap-4">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-black tracking-tight bg-linear-to-r from-foreground to-foreground/70 bg-clip-text text-transparent italic uppercase">
            Discover
          </h1>
        ...
        <p className="text-[10px] text-xs font-black text-muted-foreground/40 uppercase tracking-[0.2em] italic">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 lg:gap-6 flex-1 lg:max-w-2xl">
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-1 no-scrollbar sm:pb-0">
            <div className="md:flex hidden items-center bg-secondary/10 p-1 rounded-full border border-white/5">
              {[
