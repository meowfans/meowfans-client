    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          className="bg-zinc-900/40 border-zinc-800 text-white
           placeholder:text-zinc-700 focus-visible:ring-pink-500/50
           focus-visible:border-pink-500/50 h-12 text-center text-lg
      ...
      <div className="flex gap-3">
        <Button
          ...
          disabled={loading}
          className="border-zinc-800 bg-transparent text-zinc-400
           hover:text-white hover:bg-zinc-900 w-24 h-12 rounded-xl"
        >
          Back
        </Button>
        ...
        <LoadingButtonV2
          ...
          className="grow bg-linear-to-r from-pink-600 to-rose-600
           hover:from-pink-500 hover:to-rose-500 text-white font-bold
           h-12 rounded-xl transition-all duration-300 shadow-xl shadow-pink-600/20
           active:scale-[0.98] disabled:opacity-70"
        >
          <span className="flex items-center gap-2">Verify & Create</span>
        </LoadingButtonV2>
      </div>
