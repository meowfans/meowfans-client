...
import { ChartConfig, ChartContainer, ChartStyle, ChartTooltip, ChartTooltipContent } from '@workspace/ui/components/chart';
...
export const AnalyticsEarnings = () => {
  ...
  return (
    <Card data-chart={id} className="flex flex-col w-full mb-1">
