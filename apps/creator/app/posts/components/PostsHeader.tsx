...
export function PostsHeader({ selectedCount, onBulkDelete, isBulkDeleting }: PostsHeaderProps) {
  return (
    <motion.div
    ...
    >
      <div>
        ...
        <p className="text-sm sm:text-base text-muted-foreground mt-1">Manage, analyze, and optimize your content</p>
      </div>
      {selectedCount > 0 && (
