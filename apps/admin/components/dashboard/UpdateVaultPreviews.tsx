...
export const UpdateVaultPreviews = () => {
 ...
 <>
  ...
  <CardHeader>
   ...
   <CardDescription className="text-xs uppercase font-bold opacity-70">
   Global Maintenance Action
   </CardDescription>
  </CardHeader>
  <CardContent className="space-y-4">
   <p className="text-xs md:text-sm text-muted-foreground leading-relaxed font-medium">
   Trigger a system-wide update of all vault object previews. This will ensure all thumbnails and preview metadata are up-to-date across the platform.
   </p>
   <Button
  ...
  <div className="flex flex-col gap-6 py-4">
   ...
   <p className="text-xs font-semibold uppercase tracking-tight">
    Warning: This is a resource-intensive global action.
   </p>
   </div>
   ...
   <Button
    ...
    className="flex-1 font-bold uppercase tracking-tight rounded-xl"
   >
    Cancel
   </Button>
   <LoadingButtonV2
