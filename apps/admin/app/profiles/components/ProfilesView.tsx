   ...
   <TableBody>
    ...
    <TableRow key={creator.id} className="hover:bg-primary/5 transition-colors group border-b border-primary/5">
     ...
     <DropdownMenu>
      ...
      <DropdownMenuItem className="text-xs uppercase font-black"onClick={() => router.push(`/profiles/${creator.username}`)}>View Details</DropdownMenuItem>
      <DropdownMenuItem className="text-xs uppercase font-black">Suspend User</DropdownMenuItem>
      <DropdownMenuItem className="text-xs uppercase font-black text-destructive">Delete Account</DropdownMenuItem>
      <DropdownMenuItem className="text-xs uppercase font-black"onClick={() => onOpen(creator.id)}>
       Impersonate User
      </DropdownMenuItem>
      </DropdownMenuContent>
     </DropdownMenu>
