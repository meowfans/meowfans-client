                ...
                <TableCell className="text-center table-cell">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-48 border-primary/20 bg-card/95 backdrop-blur-xl">
                      <DropdownMenuItem className="font-black uppercase text-xs" onClick={() => onOpen(creator.id)}>
                        Impersonate User
                      </DropdownMenuItem>
                      <DropdownMenuSeparator />
                      <DropdownMenuItem
                        className="font-black uppercase text-xs text-green-500 hover:text-green-600 focus:text-green-600"
                      ...
                      <DropdownMenuItem
                        className="font-black uppercase text-xs text-destructive hover:text-destructive focus:text-destructive"
