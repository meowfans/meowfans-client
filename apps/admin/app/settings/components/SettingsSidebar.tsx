...
export type SettingsTab = 'display' | 'notifications' | 'language' | 'account-management';
          ...
          return (
            ...
            >
              ...
              <div className="text-left">
                <p className="font-black uppercase tracking-tight text-sm leading-tight">{tab.label}</p>
              </div>
              {isActive && (
