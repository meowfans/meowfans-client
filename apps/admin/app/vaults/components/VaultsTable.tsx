  ...
  return (
    <div className="flex-1 min-h-0 relative border rounded-xl bg-card overflow-hidden shadow-sm">
      {loading && creators.length === 0 ? (
        ...
        <InfiniteScrollManager dataLength={creators.length} hasMore={hasMore} onLoadMore={onLoadMore} loading={loading} useWindowScroll>
                    ...
                    <TableCell className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="space-y-0.5 min-w-0">
                          ...
                          <p className="text-[10px] text-muted-foreground font-mono truncate opacity-60">{creator.id.slice(0, 12)}...</p>
                        </div>
                      </div>
                    </TableCell>
