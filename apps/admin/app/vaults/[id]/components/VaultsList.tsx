              ...
              >
                ...
                <div className="flex-1 min-w-0 space-y-1 py-1">
                  <div className="flex items-center gap-3">
                    ...
                    {vault?.unlockPrice && (
                      <Badge className="bg-primary/90 text-[9px] md:text-[10px] font-black italic uppercase tracking-tighter px-1.5 md:px-2 py-0 h-4 md:h-5">
                        ${vault.unlockPrice}
                      </Badge>
                    )}
                  </div>
                ...
                <div className="flex items-center gap-4 md:gap-6 px-3 md:px-4 border-l border-primary/5 hidden md:flex shrink-0">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-xs md:text-sm font-black italic tabular-nums">{vault.likeCount || 0}</span>
                    </div>
                  </div>
                ...
                <div className="flex items-center gap-2 p-1 md:bg-muted/30 rounded-lg shrink-0 self-end sm:self-center">
                  <Button
                    size="sm"
                    className="flex-1 sm:flex-none font-black italic uppercase tracking-tighter text-[10px] h-8 px-4 bg-primary shadow-sm hover:shadow-md transition-all active:scale-95"
