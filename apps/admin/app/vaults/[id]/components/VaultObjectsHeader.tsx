    ...
    <div className="space-y-6">
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6">
        <div className="flex items-center gap-4 flex-1 min-w-0">
          <Avatar className="h-12 w-12 md:h-16 xl:h-20 xl:w-20 border-4 border-primary/10 shrink-0 shadow-lg">
          ...
          <div className="space-y-1 min-w-0 flex-1">
            <div className="flex flex-col md:flex-row md:items-center gap-x-3 gap-y-1">
              <h1 className="text-xl md:text-2xl xl:text-3xl font-black italic uppercase tracking-tighter truncate leading-none">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-x-4 gap-y-2 pt-1">
              <p className="text-[10px] md:text-xs xl:text-sm text-muted-foreground font-medium flex items-center gap-2">
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-[9px] md:text-[10px] xl:text-xs text-muted-foreground/60 font-bold uppercase tracking-widest whitespace-nowrap">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 xl:flex xl:flex-wrap items-center gap-2 w-full xl:w-auto shrink-0">
          {selectedCount > 0 && (
            <div className="col-span-2 md:col-span-1 xl:col-span-auto w-full xl:w-auto">
              <Button 
                ...
                size="sm" 
                className="w-full gap-2 shadow-md h-10 xl:h-9 bg-primary font-bold italic uppercase tracking-tighter text-xs"
              >
          ...
          <Button
            ...
            className="gap-2 h-10 xl:h-9 border-amber-500/50 text-amber-600 hover:bg-amber-50 font-bold italic uppercase tracking-tighter text-[10px] xl:text-xs w-full xl:w-auto"
          >
          ...
          <Button 
            ...
            className="gap-2 h-10 xl:h-9 font-bold italic uppercase tracking-tighter text-[10px] xl:text-xs w-full xl:w-auto"
          >
            <Ban className="h-3.5 w-3.5" />
            <span>Stop Jobs</span>
          </Button>
          <div className="col-span-2 md:col-span-1 xl:col-span-auto w-full xl:w-auto order-first md:order-last">
