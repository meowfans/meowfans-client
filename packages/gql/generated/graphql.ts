...
export type GetPublicCreatorPostsQuery = { __typename?: 'Query', getPublicCreatorPosts: Array<{ __typename?: 'GetPublicPostsOutput', id: string, preview: string, caption: string, createdAt: any, isLiked: boolean, objectCount: number, isPurchased: boolean, unlockPrice?: number | null, creatorAvatarUrl: string, creatorFullname: string, creatorUsername: string }> };
