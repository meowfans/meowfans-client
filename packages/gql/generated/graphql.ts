...
export type GetCreatorAssetsQuery = { __typename?: 'Query', getCreatorAssets: Array<{ __typename?: 'GetCreatorAssetsOutput', id: string, type: AssetType, rawUrl: string, blurredUrl?: string | null, creatorId: string, vaultObjectId?: string | null, viewCount?: number | null, mimeType: string, isPosted: boolean, mediaType: MediaType, fileType: FileType, displayOrder: number, createdAt: any }> };
