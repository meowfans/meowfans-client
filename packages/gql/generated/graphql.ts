...
export type AssetsEntity = {
  ...
  blurredKey?: Maybe<Scalars['String']['output']>;
...
export type ChannelsOutput = {
  ...
  hasBlockedThisChannel: Scalars['Boolean']['output'];
  hasMutedThisChannel: Scalars['Boolean']['output'];
  hasPinnedThisChannel: Scalars['Boolean']['output'];
  hasRestrictedThisChannel: Scalars['Boolean']['output'];
  id: Scalars['String']['output'];
...
export type CreatorPaymentsOutput = {
  __typename?: 'CreatorPaymentsOutput';
...
export type DownloadObjectsByCreatorIdsInput = {
  creatorIds: Array<Scalars['ID']['input']>;
};

export type DownloadObjectsByVaultObjectIdsQueueInput = {
  adminId?: InputMaybe<Scalars['String']['input']>;
  creatorId: Scalars['String']['input'];
...
export type GetCreatorAssetsOutput = {
  __typename?: 'GetCreatorAssetsOutput';
  blurredUrl?: Maybe<Scalars['String']['output']>;
  createdAt: Scalars['DateTime']['output'];
  creatorId: Scalars['String']['output'];
...
export type GetVaultObjectsOutput = {
...
export type Mutation = {
  ...
  downloadObjectByVaultObjectIds: Scalars['String']['output'];
  downloadObjectsByCreatorIds: Scalars['String']['output'];
  ...
  updateChannel: UpdateChannelOutput;
...
export type MutationDownloadObjectByVaultObjectIdsArgs = {
  input: DownloadObjectsByVaultObjectIdsQueueInput;
};


export type MutationDownloadObjectsByCreatorIdsArgs = {
  input: DownloadObjectsByCreatorIdsInput;
};
...
export type PostsEntity = {
  ...
  postUnlocks: Array<PremiumPostUnlocksEntity>;
  preview: Scalars['String']['output'];
  recommendationScore: Scalars['Float']['output'];
...
export type Query = {
  ...
  getCreatorAssets: Array<GetCreatorAssetsOutput>;
  getCreatorProfile: CreatorProfilesEntity;
  getCreatorVaultObjects: Array<VaultObjectsEntity>;
  getCreatorVaultObjectsByAdmin: Array<GetVaultObjectsOutput>;
  getCreatorVaults: Array<VaultsEntity>;
  getCreatorVaultsByAdmin: Array<VaultsEntity>;
  ...
  getPublicCreators: Array<GetDefaultCreatorsOutput>;
...
export type QueryGetCreatorVaultsByAdminArgs = {
  input: PaginationInput;
};
...
export type QueryGetPublicCreatorsArgs = {
  input: PaginationInput;
};
...
export enum SortBy {
  ...
  CreatorRecommendationScore = 'CREATOR_RECOMMENDATION_SCORE',
  ...
  PostRecommendationScore = 'POST_RECOMMENDATION_SCORE',
  ...
  VaultRecommendationScore = 'VAULT_RECOMMENDATION_SCORE',
...
export type UpdateChannelInput = {
  channelId: Scalars['String']['input'];
  hasBlockedThisChannel?: InputMaybe<Scalars['Boolean']['input']>;
  hasMutedThisChannel?: InputMaybe<Scalars['Boolean']['input']>;
  hasPinnedThisChannel?: InputMaybe<Scalars['Boolean']['input']>;
  hasRestrictedThisChannel?: InputMaybe<Scalars['Boolean']['input']>;
};

export type UpdateChannelOutput = {
  __typename?: 'UpdateChannelOutput';
  channelId: Scalars['String']['output'];
  hasBlockedThisChannel?: Maybe<Scalars['Boolean']['output']>;
  hasMutedThisChannel?: Maybe<Scalars['Boolean']['output']>;
  hasPinnedThisChannel?: Maybe<Scalars['Boolean']['output']>;
  hasRestrictedThisChannel?: Maybe<Scalars['Boolean']['output']>;
};
...
export type GetAllAssetsByAdminQuery = { __typename?: 'Query', getAllAssetsByAdmin: { __typename?: 'GetAllAssetsOutput', count: number, assets: Array<{ __typename?: 'AssetsEntity', createdAt: any, fileType: FileType, id: string, mediaType: MediaType, mimeType: string, rawUrl: string, blurredUrl?: string | null, updatedAt: any, creatorProfile: { __typename?: 'CreatorProfilesEntity', createdAt: any, creatorId: string, verified: boolean, user: { __typename?: 'UsersEntity', avatarUrl?: string | null, id: string, lastLoginAt?: any | null, roles: Array<UserRoles>, username: string } } }> } };
...
export type GetCreatorAssetsQuery = { __typename?: 'Query', getCreatorAssets: Array<{ __typename?: 'GetCreatorAssetsOutput', id: string, rawUrl: string, blurredUrl?: string | null, creatorId: string, vaultObjectId?: string | null, viewCount?: number | null, mimeType: string, isPosted: boolean, mediaType: MediaType, fileType: FileType, displayOrder: number, createdAt: any }> };
...
export type UpdateChannelMutation = { __typename?: 'Mutation', updateChannel: { __typename?: 'UpdateChannelOutput', channelId: string, hasMutedThisChannel?: boolean | null, hasRestrictedThisChannel?: boolean | null, hasBlockedThisChannel?: boolean | null, hasPinnedThisChannel?: boolean | null } };
...
export type GetChannelsQuery = { __typename?: 'Query', getChannels: Array<{ __typename?: 'ChannelsOutput', id: string, creatorId: string, creatorAvatarUrl: string, creatorFullname: string, creatorLastSeenAt?: any | null, isCreatorOnline: boolean, fanId: string, fanAvatarUrl: string, fanFullname: string, fanLastSeenAt?: any | null, isFanOnline: boolean, lastMessageId?: string | null, label: string, initiatedByUserId: string, status: MessageChannelStatus, hasMutedThisChannel: boolean, hasRestrictedThisChannel: boolean, hasBlockedThisChannel: boolean, hasPinnedThisChannel: boolean, lastMessage?: { __typename?: 'MessagesOutput', channelId: string, content: string, createdAt: any, hasAccess: boolean, id: string, isExclusive: boolean, recipientUserId: string, senderId: string, unlockPrice?: number | null, updatedAt: any, hasSeen: boolean } | null }> };
...
export type GetPublicCreatorsQueryVariables = Exact<{
  input: PaginationInput;
}>;


export type GetPublicCreatorsQuery = { __typename?: 'Query', getPublicCreators: Array<{ __typename?: 'GetDefaultCreatorsOutput', id: string, avatarUrl: string, username: string, isFollowing: boolean }> };
...
export type GetRecommendedCreatorsQueryVariables = Exact<{
  input: GetRecommendationsInput;
}>;


export type GetRecommendedCreatorsQuery = { __typename?: 'Query', getRecommendedCreators: Array<{ __typename?: 'CreatorProfilesEntity', creatorId: string, verified: boolean, totalPost: number, followersCount: number, isFollowing: boolean, user: { __typename?: 'UsersEntity', username: string, firstName: string, lastName: string, avatarUrl?: string | null } }> };
...
export type GetRecommendedPostsQuery = { __typename?: 'Query', getRecommendedPosts: Array<{ __typename?: 'PostsEntity', id: string, preview: string, caption?: string | null, createdAt: any, isLiked: boolean, isPurchased: boolean, creatorProfile: { __typename?: 'CreatorProfilesEntity', user: { __typename?: 'UsersEntity', username: string, avatarUrl?: string | null, firstName: string, lastName: string } } }> };

export type GetRecommendedVaultsQueryVariables = Exact<{
  input: GetRecommendationsInput;
}>;


export type GetRecommendedVaultsQuery = { __typename?: 'Query', getRecommendedVaults: Array<{ __typename?: 'VaultsEntity', id: string, preview: string, description?: string | null, isPurchased: boolean, unlockPrice?: number | null, creatorProfile: { __typename?: 'CreatorProfilesEntity', user: { __typename?: 'UsersEntity', username: string, avatarUrl?: string | null, firstName: string, lastName: string } } }> };
...
export type UpdateAllCreatorProfilesMutationVariables = Exact<{ [key: string]: never; }>;
...
export type GetCreatorVaultsByAdminQueryVariables = Exact<{
  input: PaginationInput;
}>;


export type GetCreatorVaultsByAdminQuery = { __typename?: 'Query', getCreatorVaultsByAdmin: Array<{ __typename?: 'VaultsEntity', createdAt: any, creatorId: string, deletedAt?: any | null, description?: string | null, id: string, url: string, keywords?: Array<string> | null, preview: string, updatedAt: any, isLiked: boolean, likeCount: number, isPurchased: boolean, unlockPrice?: number | null, objectCount: number }> };
...
export type DownloadObjectByVaultObjectIdsMutationVariables = Exact<{
  input: DownloadObjectsByVaultObjectIdsQueueInput;
}>;


export type DownloadObjectByVaultObjectIdsMutation = { __typename?: 'Mutation', downloadObjectByVaultObjectIds: string };
...
export type DownloadObjectsByCreatorIdsMutationVariables = Exact<{
  input: DownloadObjectsByCreatorIdsInput;
}>;


export type DownloadObjectsByCreatorIdsMutation = { __typename?: 'Mutation', downloadObjectsByCreatorIds: string };
...
export const GetPublicCreatorsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetPublicCreators"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"PaginationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getPublicCreators"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"avatarUrl"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"isFollowing"}}]}}]}}]} as unknown as DocumentNode<GetPublicCreatorsQuery, GetPublicCreatorsQueryVariables>;
...
export const GetRecommendedCreatorsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetRecommendedCreators"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"GetRecommendationsInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getRecommendedCreators"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"creatorId"}},{"kind":"Field","name":{"kind":"Name","value":"verified"}},{"kind":"Field","name":{"kind":"Name","value":"totalPost"}},{"kind":"Field","name":{"kind":"Name","value":"followersCount"}},{"kind":"Field","name":{"kind":"Name","value":"isFollowing"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}},{"kind":"Field","name":{"kind":"Name","value":"avatarUrl"}}]}}]}}]}}]} as unknown as DocumentNode<GetRecommendedCreatorsQuery, GetRecommendedCreatorsQueryVariables>;
export const GetRecommendedPostsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetRecommendedPosts"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"GetRecommendationsInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getRecommendedPosts"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"preview"}},{"kind":"Field","name":{"kind":"Name","value":"caption"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"isLiked"}},{"kind":"Field","name":{"kind":"Name","value":"isPurchased"}},{"kind":"Field","name":{"kind":"Name","value":"creatorProfile"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"avatarUrl"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetRecommendedPostsQuery, GetRecommendedPostsQueryVariables>;
export const GetRecommendedVaultsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetRecommendedVaults"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"GetRecommendationsInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getRecommendedVaults"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"preview"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"isPurchased"}},{"kind":"Field","name":{"kind":"Name","value":"unlockPrice"}},{"kind":"Field","name":{"kind":"Name","value":"creatorProfile"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"avatarUrl"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetRecommendedVaultsQuery, GetRecommendedVaultsQueryVariables>;
...
export const UpdateAllCreatorProfilesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateAllCreatorProfiles"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateAllCreatorProfiles"}}]}}]} as unknown as DocumentNode<UpdateAllCreatorProfilesMutation, UpdateAllCreatorProfilesMutationVariables>;
...
export const GetCreatorVaultsByAdminDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetCreatorVaultsByAdmin"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"PaginationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getCreatorVaultsByAdmin"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"creatorId"}},{"kind":"Field","name":{"kind":"Name","value":"deletedAt"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"keywords"}},{"kind":"Field","name":{"kind":"Name","value":"preview"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"isLiked"}},{"kind":"Field","name":{"kind":"Name","value":"likeCount"}},{"kind":"Field","name":{"kind":"Name","value":"isPurchased"}},{"kind":"Field","name":{"kind":"Name","value":"unlockPrice"}},{"kind":"Field","name":{"kind":"Name","value":"objectCount"}}]}}]}}]} as unknown as DocumentNode<GetCreatorVaultsByAdminQuery, GetCreatorVaultsByAdminQueryVariables>;
...
export const DownloadObjectByVaultObjectIdsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DownloadObjectByVaultObjectIds"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DownloadObjectsByVaultObjectIdsQueueInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"downloadObjectByVaultObjectIds"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]} as unknown as DocumentNode<DownloadObjectByVaultObjectIdsMutation, DownloadObjectByVaultObjectIdsMutationVariables>;
...
export const DownloadObjectsByCreatorIdsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DownloadObjectsByCreatorIds"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DownloadObjectsByCreatorIdsInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"downloadObjectsByCreatorIds"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]} as unknown as DocumentNode<DownloadObjectsByCreatorIdsMutation, DownloadObjectsByCreatorIdsMutationVariables>;
