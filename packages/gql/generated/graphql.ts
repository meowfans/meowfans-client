...
export type GetPublicCreatorProfileQuery = { __typename?: 'Query', getPublicCreatorProfile: { __typename?: 'GetPublicCreatorProfileOutput', creatorId: string, bannerUrl: string, avatarUrl: string, fullName: string, username: string, bio: string, isFollowing: boolean, totalPost: number, followersCount: number, assetCount: number, vaultCount: number, isImported: boolean } };
