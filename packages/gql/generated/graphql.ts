...
export type GetCreatorsByAdminQuery = { __typename?: 'Query', getCreatorsByAdmin: { __typename?: 'GetAllCreatorsOutput', count: number, hasNext: boolean, hasPrev: boolean, totalPages: number, creators: Array<{ __typename?: 'UsersEntity', avatarUrl?: string | null, bannerUrl?: string | null, createdAt: any, deletedAt?: any | null, firstName: string, id: string, lastLoginAt?: any | null, lastName: string, roles: Array<UserRoles>, updatedAt: any, username: string, creatorProfile: { __typename?: 'CreatorProfilesEntity', vaultCount?: number | null, vaultObjectCount?: number | null, viewCount?: number | null, creatorId: string, assetCount?: number | null, fulfilledObjectCount: number, pendingObjectCount: number, processingObjectCount: number, rejectedObjectCount: number, status: CreatorApprovalStatus } }> } };
