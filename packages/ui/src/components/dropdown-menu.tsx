...
function DropdownMenuContent({ className, sideOffset = 4, visible = true, ...props }: DropdownMenuContentProps) {
  return visible ? (
...
function DropdownMenuItem({ className, inset, visible = true, variant = 'default', ...props }: DropdownMenuItemProps) {
  return visible ? (
